...
function Check()
{
if (write2.pw.value.length < 1) {
	alert("비밀번호를 입력하세요.");
	write2.pw.focus(); 
	return false;
	}
	
if (write2.title.value.length < 1) {
	alert("글제목을 입력하세요.");
	write2.write_title.focus(); 
	return false;
        }

if (write2.content.value.length < 1) {
	alert("글내용을 입력하세요.");
	write2.content.focus(); 
	return false;
        }
...
<FORM Name='write' Action='write_input2.jsp' Method='post' OnSubmit='return Check()'>
