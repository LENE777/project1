...
function Check()
{
if (write3.pw.value.length < 1) {
	alert("비밀번호를 입력하세요.");
	write3.pw.focus(); 
	return false;
	}
	
if (write3.title.value.length < 1) {
	alert("글제목을 입력하세요.");
	write3.write_title.focus(); 
	return false;
        }

if (write3.content.value.length < 1) {
	alert("글내용을 입력하세요.");
	write3.content.focus(); 
	return false;
        }
...
<FORM Name='write' Action='write_input3.jsp' Method='post' OnSubmit='return Check()'>
